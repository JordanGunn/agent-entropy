...
None of these require the agent to be trusted. They require the agent to be bounded, which is a meaningfully different ask, and a much more achievable one.
