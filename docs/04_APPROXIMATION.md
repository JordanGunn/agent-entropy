...
- The **authority** layer is near-pure schema too: permission and governance declared once, so the agent stops inferring its remit and its operating world from the conversation.
